...
public class SampleProducerConfig {
     ...
     * 5. The max number of connections to configure the KPL with, 1 is the default.
     * 6. The requestTimeout in milliseconds to configure the KPL with, 60000 is the default.
     * 7. The bufferTime in milliseconds to configure the KPL with, 2000 is the default.
     * 8. The threading model to configure the KPL with, PER_REQUEST is the default.
     * 9. The threadPoolSize to configure the KPL with, 0 is the default.
     * 10. The aggregationEnabled to configure the KPL with, true is the default.
     * 11. The aggregationMaxCount to configure the KPL with, 4294967295 is the default.
     * 12. The aggregationMaxSize to configure the KPL with, 51200 is the default.
     */
